...
}()}(window,window.angular),angular.module("RHTest",["ngMaterial","ngAnimate","ngRoute","RHTest.services","RHTest.controllers"]).config(["$routeProvider","$locationProvider",function(a,b){"use strict";a.when("/repos",{templateUrl:"components/repos/repos-list.html",controller:"reposCtrl"}).when("/repo/:id",{templateUrl:"components/repos/repo-detail.html",controller:"repoDetailCtrl"}).otherwise({redirectTo:"/repos"})}]),angular.module("RHTest.services",[]).factory("reposServices",["$http",function(a){"use strict";var b="https://api.github.com/",c={};return c.search=function(c){var d={q:c};return a.get(b+"search/repositories",{params:d})},c.get=function(c){return a.get(b+"repositories/"+c)},c}]),angular.module("RHTest.controllers",[]).controller("reposCtrl",["$scope","$location","reposServices",function(a,b,c){"use strict";a.search={term:""},a.searchRepo=function(){a.search.term.length>2&&c.search(a.search.term).then(function(b){a.search.result=b.data})},a.goToRepo=function(a){b.path("repo/"+a)}}]).controller("repoDetailCtrl",["$scope","$routeParams","reposServices",function(a,b,c){"use strict";c.get(b.id).then(function(b){a.repo=b.data})}]);